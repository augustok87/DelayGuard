...
export class SecurityMonitor extends EventEmitter {
  ...
  private async executeAction(
    ...
    switch (action.type) {
      ...
      case "block_ip":
        this.blockIP(
          event.ipAddress,
          action.config.reason || "Automated block",
  ...
  private extractIndicators(event: SecurityEvent): string[] {
    ...
    if (event.type.includes("AUTHENTICATION_FAILURE"))
      indicators.push("auth-failure");
  ...
  private updateMetrics(event: SecurityEvent): void {
    ...
    this.metrics.threatLevels[threatLevel] =
      (this.metrics.threatLevels[threatLevel] || 0) + 1;
  }
  ...
  private setupDefaultRules(): void {
    ...
    this.addRule({
      ...
      actions: [
        ...
        {
          type: "block_ip",
          config: { reason: "Brute force attack", durationMs: 3600000 },
        },
      ],
    ...
    this.addRule({
      ...
      actions: [
        ...
        {
          type: "block_ip",
          config: { reason: "SQL injection attempt", durationMs: 7200000 },
        },
      ...
      conditions: [
        {
          field: "type",
          operator: "equals",
          value: SecurityEventType.XSS_ATTEMPT,
        },
      ],
      actions: [
        ...
        {
          type: "block_ip",
          config: { reason: "XSS attempt", durationMs: 3600000 },
        },
      ],
      cooldownMs: 300000, // 5 minutes
    });
