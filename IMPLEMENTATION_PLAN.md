...
**Status**: IN PROGRESS — Phase 2.1.a (ingestion pipeline) shipped 2026-05-15 (v1.48); Phase 2.1.b (priority score) shipped 2026-05-15 (v1.49); Phase 2.1.c (financial breakdown) shipped 2026-05-15 (v1.50); Phase 2.1.d (shipping address) shipped 2026-05-15 (v1.51). Remaining: 2.1.e–2.1.f (test-alert, customer-intelligence UI). See [CHANGELOG.md v1.51](CHANGELOG.md) for the slice-by-slice breakdown.

### 2.1 Customer Value Scoring

**Status**: 2.1.a (ingestion) ✅ SHIPPED 2026-05-15 (v1.48). 2.1.b (priority score) ✅ SHIPPED 2026-05-15 (v1.49). 2.1.c (financial breakdown) ✅ SHIPPED 2026-05-15 (v1.50). 2.1.d (shipping address) ✅ SHIPPED 2026-05-15 (v1.51). Sub-slices 2.1.e–2.1.f pending.
