...
**Status**: IN PROGRESS — Phase 2.1.a (ingestion pipeline) shipped 2026-05-15 (v1.48); Phase 2.1.b (priority score) shipped 2026-05-15 (v1.49). Remaining: 2.1.c–2.1.f (financial breakdown, shipping address, test-alert, customer-intelligence UI). See [CHANGELOG.md v1.49](CHANGELOG.md) for the slice-by-slice breakdown.
